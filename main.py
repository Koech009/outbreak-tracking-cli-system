...
class OutbreakCLI:
    ...
    # ----------------------------
        # Super Admin Menu
        # ----------------------------
    def _super_admin_menu(self):
        self.console.print("1. Promote to Admin", style="cyan")
        self.console.print("2. Manage Admin", style="cyan")
        self.console.print("3. Suspend User", style="cyan")
        self.console.print("4. Reactivate User", style="cyan")
        self.console.print("5. Delete User", style="red")
        self.console.print("6. Update Base Role", style="cyan")
        self.console.print("7. View Cases", style="green")
        self.console.print("8. View Summary", style="green")
        self.console.print("9. Logout", style="red")

        choice = input("Choose an option: ")

        if choice == "1":
            self.auth_service.promote_to_admin(self.current_user)
        elif choice == "2":
            self.auth_service.manage_admin(self.current_user)
        elif choice == "3":
            self.auth_service.suspend_user(self.current_user)
        elif choice == "4":
            self.auth_service.reactivate_user(self.current_user)
        elif choice == "5":
            self.auth_service.delete_user(self.current_user)
        elif choice == "6":
            self.auth_service.update_base_role(self.current_user)
        elif choice == "7":
    ...
    def _admin_menu(self):
        ...
        self.console.print("11. Suspend User", style="red")
        self.console.print("12. Reactivate User", style="red")
        self.console.print("13. Logout", style="red")
